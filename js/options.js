...
async function save_options() {
  ...
  const use_sync = /** @type {HTMLInputElement} */ (document.getElementById('use_sync')).checked;
...
function restore_options(items, use_sync) {
  ...
  /** @type {HTMLInputElement} */ (document.getElementById("use_sync")).checked = use_sync;
}
...
async function on_load() {
  ...
  /** @type {HTMLInputElement} */ (document.getElementById('use_sync')).addEventListener('change', on_use_sync_changed);
}
